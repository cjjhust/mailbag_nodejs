...
export class Worker {
  ...
  public async listMailboxes(): Promise<IMailbox[]> {
    ...
    const response: any = await axios.get(`${config.serverAddress}/mailboxes`);
  ...
  public async listMessages(inMailbox: string): Promise<IMessage[]> {
    ...
    const response: any = await axios.get(`${config.serverAddress}/mailboxes/${inMailbox}`);
    return response.data;
  ...
  public async getMessageBody(inID: string, inMailbox: String): Promise<string> {
    ...
    const response: any = await axios.get(`${config.serverAddress}/mailboxes/${inMailbox}/${inID}`);
    return response.data;
